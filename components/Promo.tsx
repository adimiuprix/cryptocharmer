...
import BannerGrosats from "../public/banner-grosats.jpeg";
import AdsHere from "../public/ads-here.jpg";
import AdsHereSquare from "../public/ads-here-square.webp";
const Promo = () => {
    const Icon = () => (
            ...
            <section className="w-full bg-black">
                <div className="max-w-360 mx-auto px-4 sm:px-8 lg:px-20 py-12 sm:py-16 lg:py-10">
                    ...
                    ">
                        ...
                        <div className="hidden lg:flex items-center justify-center h-full relative overflow-hidden rounded-md border border-white/10 hover:border-lime-400 transition-all duration-200">
                            <Image
                                src={AdsHereSquare}
                                alt="Square Banner"
                                width={144}
                    ...
                    <div className="mt-16 flex flex-col gap-6">
                        ...
                        <div className="w-full overflow-hidden rounded-md hover:border-1 hover:border-lime-400 transition-all duration-200">
                            <Link href="https://grosats.com/?r=68e7696800016ee5371d" target="_blank">
                                <Image
                                    src={BannerGrosats}
                                    alt="Banner 1"
                                    width={1200}
                        ...
                        <div className="w-full overflow-hidden rounded-md border border-white/10 hover:border-lime-400 transition-all duration-200">
                            <Image
                                src={AdsHere}
                                alt="Wide Banner"
                                width={1200}
